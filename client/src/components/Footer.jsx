    ...
    return (
        <footer className="footer">
            <div className="container">
                <div style={{ marginBottom: '1.25rem', fontWeight: '800', color: 'var(--primary)', fontSize: '1.1rem' }}>🎓 CampusHub</div>
                ...
                <p style={{ fontSize: '0.85rem', color: 'var(--text-light)' }}>
                    © {new Date().getFullYear()} CampusHub. The all-in-one digital hub for students.
                </p>
            </div>
        </footer>
    )
